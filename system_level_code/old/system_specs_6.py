...
def photonic_actual_loss_analysis():
	x = 1
	'''
	all_specs.at["PCM OMA Actual Loss"] = (1 - dB_to_regular(all_specs.loc["PCM OMA"])) * all_specs.loc["Total Laser Power from Wall mW"]
	print("\n")
	print(all_specs.loc["PCM OMA"])
	print(1 - dB_to_regular(all_specs.loc["PCM OMA"]))
	print(all_specs.loc["Total Laser Power from Wall mW"])
	#print(1 - dB_to_regular(all_specs.loc["PCM OMA"]))
	print("final result: ", all_specs.loc["PCM OMA Actual Loss"])
	#all_specs.at
	'''
